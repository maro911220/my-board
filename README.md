...
또한, [weatherapi](https://www.weatherapi.com/) API를 통해 사용자는 현재의 날씨와 이후 날씨를 확인할 수 있습니다. 이를 통해 사용자는 일상 생활에 필요한 날씨 정보를 손쉽게 파악할 수 있습니다.
...
- 프로젝트를 실행하기 위해서는 (themoviedb,카카오,weatherapi) API 키가 필요합니다.
